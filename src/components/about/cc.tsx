...
export default function ImageCarousel({ autoPlayMs = 4200 }) {
  // Gallery images
  const images = [
  ...
  return (
    <div className="mx-auto w-full max-w-6xl px-6 py-12">
      ...
      >
        ...
        <div className="relative h-[360px] sm:h-[460px]" style={{ perspective: "1600px" }}>
            ...
            <li key={img.src}>
              <button
                ...
                className={`h-2.5 rounded-full transition-all duration-300 ${
                  i === current ? "w-8 bg-cyan-600" : "w-2.5 bg-cyan-300"
                }`}
              />
            </li>
          ))}
